package com.exercisenice.messageBuilder;

public abstract class DocumentMessageBuilder {

    public static String tryAddDocument = "The document that was received:  ";
    ...
    public static String faultInTheDataServer = "Fault in the data server";
}
